...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="message">You recently requested to reset your password for your BudgetTracker account. Click the button below to reset it. This password reset link will expire in 60 minutes.</p>
            
            <div class="button-container">
                <a href="{{ $resetUrl }}" class="button">Reset Password</a>
            </div>
            
            <p class="message">If you didn't request a password reset, you can safely ignore this email. Your password will not be changed.</p>
